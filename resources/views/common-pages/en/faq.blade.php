@php
    ...
    $pageDescription = __('Frequently asked questions description');
@endphp
@extends('layouts.app')
...
@section('content')
    <div class="container">
        @if($inOtherLanguage ?? false)
            <div class="alert alert-warning"><i
                        class="fa fa-warning"></i> {{ __('This page is not available in your language the original version is displayed instead') }}
            </div>
        @endif
        <div class="" id="accordion">
            <div class="faqHeader">General questions</div>
            <div class="card ">
                <h4 class="panel-heading card-header">
            ...
            <div class="card ">
                <h4 class="panel-heading card-header">
                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion"
                       href="#collapseTwo">Who cen sell items?</a>
                </h4>
            ...
            <div class="card ">
                <h4 class="panel-heading card-header">
                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion"
                       href="#collapseThree">I want to sell my items - what are the steps?</a>
                </h4>
            ...
            <div class="card ">
                <h4 class="panel-heading card-header">
                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion"
                       href="#collapseSix">Why sell my items here?</a>
                </h4>
                    ...
                    <div class="card-body">
                        ...
                        <ul>
                            ...
                            <li>Fast response/approval times. Many sites take weeks to process a theme or template. And
                                if it gets rejected, there is another iteration. We have aliminated this, and made the
                                process very fast. It only takes up to 72 hours for a template/theme to get reviewed.
                            </li>
                            <li>We are not an exclusive marketplace. This means that you can sell your items on <strong>PrepBootstrap</strong>,
                                as well as on any other marketplate, and thus increase your earning potential.
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="card ">
                ...
                <div id="collapseNine" class="panel-collapse collapse">
                    <div class="card-body">
                        Our standard payment plan provides for monthly payments. At the end of each month, all
                        accumulated funds are transfered to your account.
            ...
            <div class="card ">
                ...
                <div id="collapseFour" class="panel-collapse collapse">
                    <div class="card-body">
                        Buying a theme on <strong>PrepBootstrap</strong> is really simple. Each theme has a live
                        preview.
                        Once you have selected a theme or template, which is to your liking, you can quickly and
            ...
            <div class="card ">
                ...
                <div id="collapseSeven" class="panel-collapse collapse">
                    <div class="card-body">
                        Each item in <strong>PrepBootstrap</strong> is maintained to its latest version. This ensures
