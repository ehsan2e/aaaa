@php
    \App\Facades\UIManager::setActivePath('payments');
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        @component('dashboard.components.pagination', [
                            'collection' => $payments,
                            'columnTitles' => [__('Payment Number'), __('Amount'), __('Reference Number'), __('Status'),__('Date'), __('Action')],
                            'id' => 'payment',
                            'searchBoxConfig' => [
                            ...
                            'renderer' => 'dashboard.client.payment.list-renderer',
                        ])
