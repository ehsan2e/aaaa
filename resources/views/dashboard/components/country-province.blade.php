...
<div class="form-group row">
    <label for="country_cod" class="col-md-4 col-form-label text-md-right">{{ __('Country') }}</label>
    <div class="col-md-6">
...
<div class="form-group row">
    <label for="country_cod" class="col-md-4 col-form-label text-md-right">{{ __('Province') }}</label>
    <div class="col-md-6">
