                ...
                <div class="card">
                    <div class="card-header">
                        <nav class="nav nav-pills flex-column flex-sm-row">
                            <span class="text-sm-center">{{ __('Edit Post Category') }}</span>
                    ...
                    <div class="card-body">
                        <form action="{{ route('dashboard.admin.cms.post-category.update', ['post_category' => $postCategory]) }}"
                              method="post">
                            @method('PUT')
