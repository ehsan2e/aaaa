...
return [
    ...
    */
    ...
    'custom' => [
        'accept_rules' => [
            'required' => 'Please check the accept rules checkbox.',
        ],
        'custom_attributes.*.lookupValues' => [
            'required_if' => ':attribute should have at least one selectable value'
        ],
        'image' => [
            'image' => 'Select a valid image file to upload.'
        ],
    ...
    */
    ...
    'attributes' => [
        'image_name' => 'image',
        'custom_attributes.*.caption' => 'caption',
        'custom_attributes.*.name' => 'name',
        'custom_attributes.*.type' => 'type',
    ...
    'match_password' => 'Password does not match with current password.',
    'valid_language' => 'Select a valid language.',
    'valid_parent_category' => 'Select a valid category from the same language.',
    'custom_attributes_unknown' => 'Something is wrong',
    'custom_attributes_duplicate_attribute_caption' => 'more than one attribute share :caption as their caption',
    'custom_attributes_duplicate_attribute_name' => 'more than one attribute share :name as their name',
